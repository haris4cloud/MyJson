package com.example.hariscloud.myjson;
...
//import com.example.hariscloud.myjson.Interface;
//import com.example.hariscloud.myjson.Interface.RestApi;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getData(){
        ...
        Call<Examples> call = service.getDataAdmin();
        call.enqueue(new Callback<Examples>() { //Asyncronous Request
                         @Override
